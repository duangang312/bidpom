...
class VerifyEmailAddress(Base):
    ...
    _congrats_locator = (By.ID, 'congrats')
    ...
    def verify_password(self):
        """Get the value of the password field."""
        return self.selenium.find_element(*self._verify__password_locator).text
    ...
    def enter_passwords_and_verify_account(self, password):
        ...
        WebDriverWait(self.selenium, self.timeout).until(
            lambda s: s.find_element(*self._congrats_locator).is_displayed())
